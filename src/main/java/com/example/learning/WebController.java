...
public class WebController {
    private static final int maxWaitDurationSeconds = 10;

    @GetMapping("/wait/{waitDurationSeconds}")
    public ResponseEntity<String> simulateRequest(@PathVariable int waitDurationSeconds) {
        ...
        try {
            ...
            return ResponseEntity.badRequest().body("Could not complete request!");
        }
    }
}
